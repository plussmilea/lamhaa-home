...
var copyrighted_songs = ["k4yXQkG2s1E"];
            ...
            if (data_type == 'search') {
                ...
                if (header_content.length > 0) {
                    ...
                    if (header.length > 0) {
                        ...
                        if(!copyrighted_songs.includes(video_id) && url_header.indexOf("/podcast/") == -1) {
                            var search_header = {
                                title: title_header,
                                photo: photo_header,
                                desc: desc_header,
    ...
    for (var rs = start_pos; rs < all_data_holder.length; rs++) {
        ...
        if (lists.length > 0) {
            ...
            for (var data_count = internal; data_count < lists.length; data_count++) {
                ...
                if(!copyrighted_songs.includes(video_id) && url_data.indexOf("/podcast/") == -1) {
                    var data_home = {
                        title: title_data,
                        desc: desc_data,
                        type: type,
